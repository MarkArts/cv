...
Besides work, I enjoy reading books, physical movement, gaming and reading Hacker News. \\
...
{At Quatt I'm responsible for the overall reliability, maintainability, cost and security of our infrastructure. At Quatt we work with a Platform engineering approach where we provide capabilities, in the form of tooling and workshops (for example disaster recovery or IaC 101) and golden paths, in the form of documentation and templates to teams. When I joined I started with implementing a proper AWS landing zone and introducing Pulumi and gitops principles for IaC. After that I built out and implemented our strategies for hosting (apprunner and ecs), network topology (tailscale and ipam), observability tooling (sentry/grafana/cloudwatch/axiom) and compliance (AWS Well architected reviews and preventive, detective, and proactive controls). On top of this I work closely with the development teams to improve the codebases where needed with a focus on security and reliability. These tasks range from implementing parallelization and batching of our message processing, reducing our E2E suite from 2 hours to 10min and reducing our clickhouse load by 90% by optimizing indexing and observability queries. As part of my role I work closely with both software, data and hardware engineering and frequently weigh in on architectural decisions.

\rule{0mm}{5mm}\textbf{Technologies:} Typescript, Python, Terraform, Pulumi, Flask, Deno, Docker, Nix, AWS, Grafana, Github, Sentry, CI, Axiom, Clickhouse, ECS, Apprunner, SQS, IoT Core, Snowflake, S3}
