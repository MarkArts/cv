...
{At Quatt i'm responsbile for the overal reliability, maintainability, cost and security of our infrastructure. At Quatt we work with a Platform engineering approach where we provide capabilities, in the form of tooling and workshops (for example disaster recovry or IaC 101) and golden paths, in the form of documentation and templates to teams. When i joined i started with implementing a propper AWS landing zone and introducting Pulumi and gitops principels for IaC. After that i build out and implemented our strategies for hosting (apprunner and ecs), network topology (tailscale and ipam), observability tooling (sentry/grafana/cloudwatch/axiom) and compliance (AWS Well architected reviews and preventive, detective, and proactive controls). On top of this i work closely with the development teams to improve the codebases where needed with a focus on security and reliability. These tasks range from implementing paralelization and batching of our message proceccing, reducing our E2E suite from 2 hours to 10min and reducing our clickhouse load by 90% by optimizing indexing and observability querries. As part of my role i work closely with both software, data and hardware engineering and frequently wiegh in on architectual decicions.
