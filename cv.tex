...
During and after finishing my studies I worked as a backender, grew into a DevOps and eventually became an platform engineer. I am proactive in learning new skills and picking up tasks outside of my funtion description. Because of that next to platform and cloud engineering i have concistently contributed to  backend and frontend code and have worked on multiple high performance applications improving performance, stability and observability. My preference tends to be a supportive role enabling people around me to ship fast and deliver high quality code but I am just as confident architecting and implementing features as designing infrastructure and writing IaC.

As a team member or lead i enjoy providing my teammates opportunities to develop their skills, improving our processes by regular reflection, taking charge of our infrastructure efficiency, security, cost, and reliability, and planning out architectual and implementation details. 
...
{At Quatt I'm responsible for the overall reliability, maintainability, cost and security of our infrastructure. At Quatt we work with a Platform engineering approach where we provide capabilities, in the form of tooling and workshops (for example disaster recovery or IaC 101) and golden paths, in the form of documentation and templates to teams. When I joined I started with implementing a proper AWS landing zone and introducing Pulumi and gitops principles for IaC. After that I built out and implemented our strategies for hosting (apprunner and ecs), network topology (tailscale and ipam), observability tooling (sentry/grafana/cloudwatch/axiom) and compliance (AWS Well architected reviews and preventive, detective, and proactive controls). On top of this I work closely with the development teams to improve the codebases where needed with a focus on security and reliability. These tasks range from implementing parallelization and batching of our message processing, reducing our E2E suite from 2 hours to 10min and reducing our clickhouse load by optimizing indexing and observability queries. As part of my role I work closely with both software, data and hardware engineering and frequently weigh in on architectural decisions. With the advent of LLM's i have played a crucial role in the adaption of LLM's outside of code generation by providing knowledge  sessions, building tools, defining access policies, controlling cost and giving architectual guidance. This has resulted in reducing triage time for custumor support from hours to minutes, virtual hardware rigs allowing us to expand the surface of our E2E testing suites, non programmes (like TAM, Sales, Support. PM's) contributing and even creating new repositories to deploy services matching our quality standarts and requirments for code, IaC, security, CI/CD etc.
